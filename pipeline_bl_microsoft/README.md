...
If you want to add, remove, or modify the query words used for sentence extraction and masked-word prediction, the metadata generation steps (Steps 1-3) do not need to be rerun.

All you need to do is to update the query word configuration used by the filtering stage, by modifying the following line inside 
