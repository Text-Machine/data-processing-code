...
zip_path = "/gpfs/projects/bsc100/textmachine-data/downloaded_data_vm/15056046/hmd-csv.zip"
output_dir = "/gpfs/projects/bsc100/textmachine-data/preprocessed_data/output_hmd"
    ...
    with zipfile.ZipFile(zip_path) as z:
        with z.open(csv_filename) as f:
            ...
            for i, chunk in enumerate(reader):
                # Generate article_id from plain_text_file path
                chunk["article_id"] = (
                    chunk["plain_text_file"]
                    .astype(str)
                ...
                # Define metadata and content columns
                metadata_cols = [
                ...
                meta_chunk = chunk[[c for c in metadata_cols if c in chunk.columns]]
                content_chunk = chunk[[c for c in content_cols if c in chunk.columns]]
...
with zipfile.ZipFile(zip_path) as z:
    for csv_file in z.namelist():
        if csv_file.endswith(".csv"):
            ...
            process_csv_from_zip(zip_path, csv_file, output_dir, chunksize=chunksize, date_cutoff=date_cutoff)