...
MODELS = {
    "pred_newsbert_1800_1920":    f"{MODELS_BASE}/newsbert_1800_1920",
...
def main():
    ...
    # step-5 files for the words listed in QUERY_WORDS and the dataset
    ...
    for word in QUERY_WORDS:
        ...
        fp = input_path / f"{PREFIX}_{slug}{suffix_part}_step_5.jsonl"
