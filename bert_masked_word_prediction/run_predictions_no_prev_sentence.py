...
- Dropped prev_sentence from context; uses only masked_sentence +
  next_sentence, truncated to 512 tokens if needed
"""
...
OUTPUT_BASE = (
    ...
    "filtered_data_predictions_bert_mask_predicted_repeat"
)
